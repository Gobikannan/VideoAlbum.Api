...
using VideoAlbum.Application;
using VideoAlbum.Common.Config;
using VideoAlbum.Persistence;
using System.Reflection;
using System.Threading.Tasks;

namespace VideoAlbum.WebApi
{
    /// <summary>
    /// Startup
    /// </summary>
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.IncludeXmlComments(string.Format(@"{0}\VideoAlbum.xml", System.AppDomain.CurrentDomain.BaseDirectory));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "VideoAlbum");
            });
            #endregion
        }
    }
